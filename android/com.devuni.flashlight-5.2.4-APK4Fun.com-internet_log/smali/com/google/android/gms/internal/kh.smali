...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/internal/kh;->a:Ljava/util/concurrent/ThreadFactory;

    const/16 v0, 0xa

    sget-object v1, Lcom/google/android/gms/internal/kh;->a:Ljava/util/concurrent/ThreadFactory;

    invoke-static {v0, v1}, Ljava/util/concurrent/Executors;->newFixedThreadPool(ILjava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    sput-object v0, Lcom/google/android/gms/internal/kh;->b:Ljava/util/concurrent/ExecutorService;
...
.method public static a(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;
    ...
    invoke-direct {v0, p0}, Lcom/google/android/gms/internal/ki;-><init>(Ljava/lang/Runnable;)V
...
.method public static a(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
    ...
    :try_start_0
    sget-object v0, Lcom/google/android/gms/internal/kh;->b:Ljava/util/concurrent/ExecutorService;

    new-instance v1, Lcom/google/android/gms/internal/kj;

    invoke-direct {v1, p0}, Lcom/google/android/gms/internal/kj;-><init>(Ljava/util/concurrent/Callable;)V
